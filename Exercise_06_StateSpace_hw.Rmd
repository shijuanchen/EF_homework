...
# time = as.Date(gflu$Date)
# y = gflu$Massachusetts
# plot(time,y,type='l',ylab="Flu Index",lwd=1,log='y')
# points(time,y,pch="+",cex=0.5, col=2)
```
```{r}
# 
gflu = read.csv("http://www.google.org/flutrends/about/data/flu/us/data.txt",skip=11)
...
# print(time_m[1:30])
# print(y_m[1:30])
# plot(time_m,y_m,type='l',ylab="Flu Index",lwd=1,log='y')
# points(time_m,y_m,pch="+",cex=0.5, col=2)
```

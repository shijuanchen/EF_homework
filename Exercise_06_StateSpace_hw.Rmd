...
Comparison of the CI between the two runs: ...
...
```{r}
hist(1/sqrt(out[,1]),main=colnames(out)[1], breaks=400)
hist(1/sqrt(out[,2]),main=colnames(out)[2], breaks=400)
```
```{r}
hist(1/sqrt(out_lm[,4]),main=colnames(out_lm)[4], breaks=400)
hist(1/sqrt(out_lm[,5]),main=colnames(out_lm)[5], breaks=400)
```

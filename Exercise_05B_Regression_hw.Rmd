...
```
```{r}
burnin2 = 5000 # determine the burn in as 4000 steps.
...
beta1 = var.mat2[,c("beta[1]")]
hist(beta1, breaks = 100)
beta2 = var.mat2[,c("beta[2]")]
hist(beta2, breaks = 100)
precision = var.mat2[,c("prec")]
hist(precision, breaks = 100)
```

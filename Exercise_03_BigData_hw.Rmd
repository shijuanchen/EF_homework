...
#plot(x, log = abund)
#test = sum(tree_count,na.rm=TRUE)
#print(test)
```
...
```{r}
#system("wget http://flux.aos.wisc.edu/data/cheas/wlef/netcdf/US-PFa-WLEF-TallTowerClea#n-2012-L0-vFeb2013.nc")
# I could not make this line working, so I manually donwloaded the netCDF data.
```
